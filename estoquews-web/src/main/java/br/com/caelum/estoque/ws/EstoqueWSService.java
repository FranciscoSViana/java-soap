 ...
 * 2022-06-21T18:15:44.752-03:00
 * Generated source version: 2.7.13
 * 
 */
@WebServiceClient(name = "EstoqueWSService", 
                  wsdlLocation = "file:/C:/workspaces/ws-alura/estoquews-web/src/main/java/EstoqueWSServiceCap5.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/workspaces/ws-alura/estoquews-web/src/main/java/EstoqueWSServiceCap5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/workspaces/ws-alura/estoquews-web/src/main/java/EstoqueWSServiceCap5.wsdl");
        }
        WSDL_LOCATION = url;
    }
